...
void aboutFrame(){
    ...
    settextstyle(7,0,2);
    setcolor(7);
    outtextxy(halfx-150,halfy,"DEVELOPER");
    outtextxy(halfx,halfy,"ROCKY JAIN");
    outtextxy(halfx-150,halfy+40,"CLASS");
    outtextxy(halfx,halfy+40,"CSE 2");
    outtextxy(halfx-50,halfy+90,"jainrocky1008@gmail.com");
    drawpoly(6,back);
    settextstyle(1,0,1);
    setcolor(10);
